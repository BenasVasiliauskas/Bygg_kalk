...
DataTable buildFirstTable(sumLaborCosts, sumMaterialCosts, totalHours) {
  return DataTable(
    columnSpacing: 10,
    columns: [
      DataColumn(
          ...
          cells: [
                  ...
                  index == calculatedNamesOrder.length - 1
                      ? totalHours
                          .reduce((value, element) =>
                              (value as double) + (element as double))
                          .toStringAsFixed(2)
                      : (totalHours[index] as double).toStringAsFixed(2),
                ),
              ),
            ),
            DataCell(
              SizedBox(
                ...
                child: Text(
                  index == calculatedNamesOrder.length - 1
                      ? (sumLaborCosts as double).toStringAsFixed(2)
            ...
            DataCell(
              SizedBox(
                ...
                child: Text(
                  index == calculatedNamesOrder.length - 1
                      ? (sumMaterialCosts as double).toStringAsFixed(2)
...
DataTable buildSecondTable(
    double sumLaborCosts, double sumMaterialCosts, double sumWasteRemoval) {
  return DataTable(
    columnSpacing: 10,
    columns: [
      DataColumn(
    ...
    rows: [
      ...
      DataRow(
        cells: [
          ...
          DataCell(
            Text(
                (sumWasteRemoval + sumWasteRemoval * costs).toStringAsFixed(2) +
                    "\$"),
          ),
        ],
      ),
      ...
      DataRow(
        cells: [
          ...
          DataCell(
            Text(
              (sumLaborCosts + sumMaterialCosts + (costs * sumLaborCosts))
                      .toStringAsFixed(2) +
                  "\$",
            ),
          ),
