...
class HullRoofingItemScreen extends StatefulWidget {
  String name;
  ...
  @override
  State<HullRoofingItemScreen> createState() => _HullRoofingItemScreenState();
}
...
// Update the "Total Sum" row in the updateTotalSum method
  ...
  void initialiseStates() {
    ...
    if (hullCalculationControllers.text != "")
      calculationQuantity = double.parse(hullCalculationControllers.text);
  }
            ...
            children: [
              ...
              FloatingActionButton(
                onPressed: () async {
                  ...
                  writeJson(hullRoofingModel, name);
