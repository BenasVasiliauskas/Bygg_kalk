...
class ScaffoldingItemScreen extends StatefulWidget {
  String name;
  ...
  @override
  State<ScaffoldingItemScreen> createState() => _ScaffoldingItemScreenState();
}
...
// Update the "Total Sum" row in the updateTotalSum method
  ...
  void initialiseStates() {
    ...
    if (scaffoldingCalculationControllers.text != "")
      calculationQuantity =
          double.parse(scaffoldingCalculationControllers.text);
  }
