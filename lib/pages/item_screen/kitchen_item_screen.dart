...
class KitchenItemScreen extends StatefulWidget {
  String name;
  ...
  @override
  _KitchenItemScreenState createState() => _KitchenItemScreenState();
}

List<double> emptyCustomList = [];

class _KitchenItemScreenState extends State<KitchenItemScreen> {
  List<DataRow> rows = [];
                    ...
                    readJsonFile(name).then(
                      (value) {
                        KitchenModel kitchenModel =
                            KitchenModel.fromJson(value);
                        setState(() {
                          widget.description = kitchenModel.description;
                          widget.unit = kitchenModel.unit;
                          widget.quantity = kitchenModel.quantity;
                          widget.laborHours1 = kitchenModel.laborHours1;
                          widget.laborHours2 = kitchenModel.laborHours2;
                          widget.laborCost = kitchenModel.laborCost;
                          widget.material1 = kitchenModel.material;
                          widget.material2 = kitchenModel.materials;
                          widget.totalPrice = kitchenModel.totalPrice;
