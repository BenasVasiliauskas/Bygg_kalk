...
class PolTerraceItemScreen extends StatefulWidget {
  String name;
  ...
  @override
  State<PolTerraceItemScreen> createState() => _PolTerraceItemScreenState();
}

//
TextEditingController polTerraceCalculationControllers =
...
// Update the "Total Sum" row in the updateTotalSum method
  ...
  void initialiseStates() {
    ...
    if (polTerraceCalculationControllers.text != "")
      calculationQuantity = double.parse(polTerraceCalculationControllers.text);
  }
  ...
  void _updateLaborHours() {
    ...
    for (int i = 0; i < polTerraceData.length; i++) {
      if (polTerraceData[i].name == widget.name) {
        setState(() {
          for (int j = 0; j < polTerraceData[i].laborHours1.length; j++) {
            widget.laborHours1[j] = polTerraceData[i].laborHours1[j];
          }
        });
        return;
      }
                          ...
                          for (int i = 0; i < value.length; i++) {
                            ...
                            if (terraceModel.name == widget.name) {
                              setState(() {
                                ...
                                widget.material1 = terraceModel.material;
                                widget.material2 = terraceModel.materials;
