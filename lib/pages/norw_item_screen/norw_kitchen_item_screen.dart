...
class NorwKitchentemsScreen extends StatefulWidget {
  final String name;
  ...
  @override
  _NorwKitchentemsScreenState createState() => _NorwKitchentemsScreenState();
}

List<double> emptyCustomList = [];

class _NorwKitchentemsScreenState extends State<NorwKitchentemsScreen> {
  List<DataRow> rows = [];
    ...
    List<DataColumn> columns = [
      ...
      DataColumn(
        label: SizedBox(
          ...
          child: Text(
            'Enh. tid.',
            style: TextStyle(color: customColumn ? Colors.grey : Colors.black),
          ),
        ),
      ),
      DataColumn(
        ...
        child: TextButton(
          ...
          child: customColumn ? Text("Tilpassede timer") : Text("+"),
        ),
      )),
      DataColumn(
        label: SizedBox(
      ...
      DataColumn(
        label: SizedBox(
          width: 100, // Set the width as needed
          child: Text('Enh. mater.'),
        ),
      ),
      DataColumn(
        label: SizedBox(
          width: 100, // Set the width as needed
          child: Text('Sum. material'),
        ),
      ),
      DataColumn(
        label: SizedBox(
          width: 100, // Set the width as needed
          child: Text('Total pris'),
        ),
      ),
    ];
