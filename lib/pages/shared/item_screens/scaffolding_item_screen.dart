                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: TextField(
                                  controller:
                                      norwScaffoldingCalculationControllers,
                                  onChanged: (value) {
                                    setState(() {
                                      norwScaffoldingCalculationControllers
                                          .text = value;
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: TextField(
                                      controller:
                                          polScaffoldingCalculationControllers,
                                      onChanged: (value) {
                                        setState(() {
                                          polScaffoldingCalculationControllers
                                              .text = value;
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: TextField(
                                      controller:
                                          litScaffoldingCalculationControllers,
                                      onChanged: (value) {
                                        setState(() {
                                          litScaffoldingCalculationControllers
                                              .text = value;
