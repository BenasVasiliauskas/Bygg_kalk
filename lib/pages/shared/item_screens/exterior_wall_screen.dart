...
import 'package:cost_calculator/data/norwegian%20data%20folder/outer_wall_units.dart';
...
class _ExteriorWallScreenState extends State<ExteriorWallScreen> {
  ...
  void _calculateTotals() {
    ...
    // Sum up the values for each item in filteredExteriorWallData
    for (var item in filteredExteriorWallData) {
