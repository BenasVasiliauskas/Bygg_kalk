...
import 'package:cost_calculator/bathroom_data/lit_data.dart';
import 'package:cost_calculator/bathroom_data/norw_data.dart';
import 'package:cost_calculator/bathroom_data/pol_data.dart';
...
class WindowsScreen extends StatefulWidget {
  ...
  const WindowsScreen({Key? key, required this.constructionType})
      : super(key: key);

  State<WindowsScreen> createState() => _WindowsScreen();
}

class _WindowsScreen extends State<WindowsScreen> {
  ...
  void initState() {
    ...
    filteredWindowsExteriorDoors = languageEnglish
        ? bathroomWindowsData // change to bathroom items
        : languageNorwegian
            ? bathroomWindowsDataNorw //norw version
            : languagePolish
                ? bathroomWindowsDataPol //pol version
                : bathroomWindowsDataLit; //lit version
                      ...
                      child: TextField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            bathroomWindowsData[index].calculationQuantity =
                                parsedValue;
                            bathroomWindowsDataNorw[index].calculationQuantity =
                                parsedValue; // norw
                            bathroomWindowsDataPol[index].calculationQuantity =
                                parsedValue; // pol
                            bathroomWindowsDataLit[index].calculationQuantity =
                                parsedValue; // lit
